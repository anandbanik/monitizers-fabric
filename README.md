# Car-Sales Application for Hyperledger Fabric 1.0
...
Deploy Portainer UI and other auxillary services.
```bash
./network -m util-up
```

Access the Portainer UI from [http://localhost:9000/](http://localhost:9000/)
